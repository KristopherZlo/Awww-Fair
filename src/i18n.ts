...
export const UI_TEXT = {
  ru: {
    ...
    campaignMode: "Сюжетный режим",
    twoPlayers: "2 игрока",
    versusAi: "Против ИИ",
    aiTraining: "Обучение с ИИ",
    onlineGame: "Свой стол",
    ...
    lobbyConnectionLost: "Соединение с интернетом пропало. Пытаемся переподключиться...",
    back: "Назад",
  ...
  en: {
    ...
    campaignMode: "Story mode",
    twoPlayers: "2 players",
    versusAi: "Versus AI",
    aiTraining: "AI training",
    onlineGame: "Custom table",
    ...
    lobbyConnectionLost: "Internet connection lost. Trying to reconnect...",
    back: "Back",
